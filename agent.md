...
MiroFish — AI-движок прогнозирования на основе мультиагентных технологий. Из форумов автоматически строится параллельный цифровой мир с тысячами агентов, которые взаимодействуют на платформах Twitter и Reddit. Результат — прогнозный отчёт и интерактивный мир для глубокого анализа.
...
1. **Построение графа** — автопарсинг форумов → LLM-онтология → Zep GraphRAG → D3.js визуализация
...
- Выбор тем из Pikabu, Habr, VC.ru
