...
// Step State
const currentStep = ref(1) // 1: Построение графа, 2: Настройка среды, 3: Запуск симуляции, 4: Генерация отчёта, 5: Взаимодействие
...
const startGraphPolling = () => {
  addLog('Начат опрос данных графа...')
  fetchGraphData()
