  ...
  >
    ...
    <div v-if="projects.length > 0" class="cards-container" :class="{ expanded: isExpanded }" :style="containerStyle">
      ...
      >
        ...
        <!-- 卡片标题（使用Требования симуляции的前20字作为标题） -->
        <h3 class="card-title">{{ getSimulationTitle(project.simulation_requirement) }}</h3>

        <!-- 卡片描述（Требования симуляции完整展示） -->
        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <!-- Требования симуляции -->
              <div class="modal-section">
                <div class="modal-label">Требования симуляции</div>
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step3 «Симуляция» и Step5 «Взаимодействие» требуют запуска в реальном времени и не поддерживают воспроизведение</span>
            </div>
          </div>
        </div>
      </Transition>
...
// 从Требования симуляции生成标题（取前20字）
...
// 导航到Аналитический отчёт页面（Report）
const goToReport = () => {
