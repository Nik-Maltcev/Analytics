        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Отправить опрос агентам</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Быстрый диалог с Report Agent, 4 профессиональных инструмента, полная память MiroFish</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InsightForge Глубокий анализ</div>
                    <div class="tool-desc">Сопоставление реальных данных и состояния симуляции с механизмом Global/Local Memory для глубокого анализа</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Алгоритм обхода графа для реконструкции путей распространения событий</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Мгновенный запрос через GraphRAG для быстрого извлечения атрибутов узлов и фактов</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Автономное интервью с параллельными диалогами для сбора мнений и психологических состояний агентов</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Общайтесь с Report Agent для анализа отчёта' : 'Общайтесь с агентами, чтобы узнать их мнение' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Выберите респондентов</span>
...
const sendToAgent = async (message) => {
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .slice(-6)
      .map(msg => `${msg.role === 'user' ? 'Вопрос' : 'Вы'}：${msg.content}`)
      .join('\n')
    prompt = `Наш предыдущий диалог:\n${historyContext}\n\nМой новый вопрос: ${message}`
  }
